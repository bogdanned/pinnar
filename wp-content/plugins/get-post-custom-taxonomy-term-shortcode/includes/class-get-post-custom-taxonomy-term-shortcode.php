...
class Get_Post_Custom_Taxonomy_Term_Shortcode {
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action('wp_ajax_nopriv_get_post_per_page', $plugin_admin, 'get_post_per_page');
        $this->loader->add_action('wp_ajax_get_post_per_page', $plugin_admin, 'get_post_per_page');
        ...
        $this->loader->add_action('add_meta_boxes', $plugin_admin, 'gtsortcode_register_meta_boxes');
    ...
    private function define_public_hooks() {
        ...
        $this->loader->add_action('wp_head', $plugin_public, 'gtsort_custom_css');
